...
<div class="mainindex">
    ...
    <div class="welinfo">
        <b>{{$row->ad_name}}</b>，欢迎使用后台管理系统
    </div>

    <div class="welinfo">
        <span><img src="{{asset('Admin/images/time.png')}}" alt="时间" /></span>
        <i>您上次登录的时间：{{date('Y-m-d H:i:s',$last_time)??''}}</i> <i>您上次登录IP：127.0.0.1</i> 如非本人操作，请及时<a href="#">更改密码</a>
    </div>
    ...
    <ul class="infolist">
        ...
        <li><span>服务器地址：</span>www.cqshop.com</li>
    ...
    <div class="uimakerinfo">
        <b>版权所有：传奇商城</b>(<a href="http://www.yhshop.com" target="_blank">www.cqshop.com</a>)
    </div>
</div>
